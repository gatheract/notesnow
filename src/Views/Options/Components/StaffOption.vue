...
const imgGStaff = require('@/assets/images/g_staff_option_mini.png')
const imgFStaff = require('@/assets/images/f_staff_option_mini.png')
const imgBoth = require('@/assets/images/both_staff_option_mini.png')

  ...
  <div class="mainContainer">
    ...
    <div>
      <div class="levelSelect">
        <RadioGroup v-on:on-change="changeDifficulty" size="large" type="button">
      ...
      <Button v-on:click="startGame" size="large" id="gameStart" type="error">{{$t("mainScreen.startButton")}}</Button>
    </div>
  </div>
</template>
...
export default class GamerContainer extends Vue {
  @settingsModule.Getter(DIFFICULTY_LEVEL) difficultyLevel: DifficultyLevel
  @settingsModule.Action(SET_DIFFICULTY) setDifficulty: any
...
h1.title { color:black; font-family: 'Arial', sans-serif; font-size: 54px; font-weight: 600; line-height: 58px;  }
h2.subtitle { color: #7c795d; font-family: 'Source Sans Pro', sans-serif; font-size: 28px; font-weight: 400; line-height: 32px;  }
